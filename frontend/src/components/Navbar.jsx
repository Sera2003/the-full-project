...
const Navbar = () => {
          ...
          <Link to='/'>  <img src={assets.logo} className='w-36' alt="Logo" /></Link>
            ...
            <div className='flex items-center gap-6'>
                <img onClick={()=>{setShowSearch(true);
                    setVisible(false);}
                } src={assets.search_icon} className="w-7 cursor-pointer" alt="searchicon" />
                <div className='group relative'>
                  <img onClick={()=> token ? null : navigate('/login')} className='w-7 cursor-pointer' src={assets.profile_icon} alt="account" /> 
                  {/* Dropdown Menu*/}
                  {token &&                     
                ...
                <NavLink to='/cart' className='relative'>
                    <img src={assets.cart_icon} className="w-5 min-w-7" alt="carticon" />
                ...
                <img onClick={() => setVisible(true)} src={assets.menu_icon} className='w-7 cursor-pointer sm:hidden' alt="menu_icon" />
            </div>
    ...
    <div onClick={() => setVisible(false)} className='flex items-center gap-2 p-3 cursor-pointer'>
        <img className='h-7 rotate-90' src={assets.dropdown_icon} alt="Back" />
        <p>Back</p>
